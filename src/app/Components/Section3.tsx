    ...
    <div className=' py-10'>
        ...
        <div className='my-6 sm:flex'>
            <div className='w-fit p-4 mx-auto my-2'>
                <div>
                    <Image src="/TS1.png" alt='loading' width={200} height={200}></Image>
                </div>
                <div className='mt-2'>
                    <h1 className='text-black font-bold'>Vertical Stripped Shirts</h1>
                </div>
                <div className='mt-2'>
            ...
            <div className='w-fit p-4 mx-auto my-2'>
                <div>
                    <Image src="/TS2.png" alt='loading' width={200} height={200}></Image>
                </div>
                <div className='mt-2'>
                    <h1 className='text-black font-bold'>Courage Graphic T-Shirt</h1>
                </div>
                <div className='mt-2'>
            ...
            <div className='w-fit p-4 mx-auto my-2 hidden md:block'>
                <div>
                    <Image src="/TS3.png" alt='loading' width={200} height={200}></Image>
                </div>
                <div className='mt-2'>
                    <h1 className='text-black font-bold'>Loose Fit Bermuda Shorts</h1>
                </div>
                <div className='mt-2'>
            ...
            <div className='w-fit p-4 mx-auto my-2 hidden lg:block'>
                <div>
                    <Image src="/TS4.png" alt='loading' width={200} height={200}></Image>
                </div>
                <div className='mt-2'>
                    <h1 className='text-black font-bold'>Faded Skinny Jeans</h1>
                </div>
                <div className='mt-2'>
                    <h1 className='text-black font-bold'>Rs: 1500</h1>
                </div>
